    ...
    return (
      <div className="w-full flex flex-col gap-1.5">
        ...
        <textarea
          id={inputId}
          className={cn(
            "flex min-h-[80px] w-full rounded-xl border border-border bg-surface px-3 py-2 text-xs font-medium placeholder:text-slate-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 disabled:cursor-not-allowed disabled:opacity-50 transition-all",
